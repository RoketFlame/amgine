...
class Ui_Number_Systems_Main(object):
    ...
    def retranslateUi(self, Number_Systems_Main):
        ...
        self.label_2.setText(_translate("Number_Systems_Main", "<html><head/><body><p><span style=\" font-size:12pt; color:#ffffff;\">Вывод</span></p></body></html>"))
        self.label_4.setText(_translate("Number_Systems_Main", "<html><head/><body><p><span style=\" font-size:10pt; color:#ffffff;\">Сохранить текст</span></p></body></html>"))
        self.label_11.setText(_translate("Number_Systems_Main", "<html><head/><body><p><span style=\" font-size:12pt; color:#ffffff;\">Ввод</span></p></body></html>"))
        self.label_3.setText(_translate("Number_Systems_Main", "<html><head/><body><p><span style=\" font-size:10pt; color:#ffffff;\">Загрузить текст</span></p></body></html>"))
        ...
        self.label.setText(_translate("Number_Systems_Main", "<html><head/><body><p align=\"center\"><span style=\" font-size:10pt; color:#ffffff;\">Выберите основание системы счисления</span></p></body></html>"))
        self.label_5.setText(_translate("Number_Systems_Main", "<html><head/><body><p><span style=\" color:#ffffff;\">Зашифровать</span></p></body></html>"))
        self.label_6.setText(_translate("Number_Systems_Main", "<html><head/><body><p><span style=\" color:#ffffff;\">Дешифровать</span></p></body></html>"))
