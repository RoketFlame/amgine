...
class Ui_Caesar_Main_Window(object):
    def setupUi(self, Caesar_Main_Window):
        ...
        Caesar_Main_Window.resize(647, 596)
        ...
        self.line_edit_key.setGeometry(QtCore.QRect(260, 480, 131, 31))
        self.line_edit_key.setObjectName("line_edit_key")
        self.label_9 = QtWidgets.QLabel(self.centralwidget)
        self.label_9.setGeometry(QtCore.QRect(70, 480, 181, 31))
        self.label_9.setObjectName("label_9")
        self.save_settings_btn = QtWidgets.QPushButton(self.centralwidget)
        self.save_settings_btn.setGeometry(QtCore.QRect(410, 480, 121, 31))
        ...
        self.label_3.setGeometry(QtCore.QRect(10, 250, 231, 31))
    ...
    def retranslateUi(self, Caesar_Main_Window):
        ...
        self.save_settings_btn.setText(_translate("Caesar_Main_Window", "Сохранить настройки"))
        ...
        self.btn_load_text.setText(_translate("Caesar_Main_Window", "Загрузка"))
        self.btn_save_text.setText(_translate("Caesar_Main_Window", "Сохранение"))
