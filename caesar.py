...
class Ui_Caesar_Main_Window(object):
    def setupUi(self, Caesar_Main_Window):
        ...
        self.save_key_btn = QtWidgets.QPushButton(self.centralwidget)
        self.save_key_btn.setGeometry(QtCore.QRect(410, 550, 121, 31))
    ...
    def retranslateUi(self, Caesar_Main_Window):
        ...
        self.save_key_btn.setText(_translate("Caesar_Main_Window", "Сохранить ключ"))
